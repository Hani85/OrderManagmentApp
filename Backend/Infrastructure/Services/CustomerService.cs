...
namespace Infrastructure.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public async Task<Customer> AddOrUpdateCustomerAsync(CustomerModel customerModel)
        {
             ...
             if(customerModel.Id == null)
             {
                customer = new Customer
                {
                    ...
                    Address = new Address{
                        AdressLine1 = customerModel.AdressLine1,
                        AdressLine2 = customerModel.AdressLine2,
             ...
             else
             {
                ...
                customer.Address.AdressLine1 = customerModel.AdressLine1;
                customer.Address.AdressLine2 = customerModel.AdressLine2;
        ...
        public async Task<bool> DeleteCustomerAsync(int customerId)
        {
            ...
            if(customer == null)
                throw new Exception($"Custom with id {customerId} was not found");
